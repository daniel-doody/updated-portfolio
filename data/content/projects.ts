...
const projects: Project[] = [
  {
    id: 0,
    title: 'Danbnb',
    desc: 'A booking website with full search, date picker & mapbox functionality.',
    img: '/static/projects/danbnb.png',
    link: 'https://danbnb-daniel-doody.vercel.app/',
  ...
  },
  {
    id: 1,
    title: 'My Notes',
    desc: 'An advanced note-taking app with categories/tags, markdown support, filtering, etc.',
